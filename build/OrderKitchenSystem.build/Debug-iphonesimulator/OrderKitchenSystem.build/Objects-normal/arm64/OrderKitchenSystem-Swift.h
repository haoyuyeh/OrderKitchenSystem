...
#ifndef ORDERKITCHENSYSTEM_SWIFT_H
#define ORDERKITCHENSYSTEM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OrderKitchenSystem",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18OrderKitchenSystem11AppDelegate")
...
@interface Catagory (SWIFT_EXTENSION(OrderKitchenSystem))
- (void)addHasObject:(Option * _Nonnull)value;
- (void)removeHasObject:(Option * _Nonnull)value;
- (void)addHas:(NSSet * _Nonnull)values;
- (void)removeHas:(NSSet * _Nonnull)values;
@end
...
@interface Item (SWIFT_EXTENSION(OrderKitchenSystem))
@property (nonatomic, copy) NSString * _Nullable name;
...
- (void)addNextObject:(Option * _Nonnull)value;
- (void)removeNextObject:(Option * _Nonnull)value;
- (void)addNext:(NSSet * _Nonnull)values;
- (void)removeNext:(NSSet * _Nonnull)values;
@end
...
@interface Order (SWIFT_EXTENSION(OrderKitchenSystem))
- (void)addHasObject:(Item * _Nonnull)value;
- (void)removeHasObject:(Item * _Nonnull)value;
- (void)addHas:(NSSet * _Nonnull)values;
- (void)removeHas:(NSSet * _Nonnull)values;
@end
...
SWIFT_CLASS("_TtC18OrderKitchenSystem13SceneDelegate")
